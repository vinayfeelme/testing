...
then
 ...
 $WGET  --load-cookies="$COOKIE_FILE" "https://updates.oracle.com/Orion/Services/download/p6880880_190000_Linux-x86-64.zip?aru=26065334&patch_file=p6880880_190000_Linux-x86-64.zip" -O "$OUTPUT_DIR/p6880880_190000_Linux-x86-64.zip"   >> "$LOGFILE" 2>&1
