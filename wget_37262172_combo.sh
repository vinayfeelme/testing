...
then
 ...
 $WGET  --load-cookies="$COOKIE_FILE" "https://updates.oracle.com/Orion/Services/download/p37262172_190000_Linux-x86-64.zip?aru=26043816&patch_file=p37262172_190000_Linux-x86-64.zip" -O "$OUTPUT_DIR/p37262172_190000_Linux-x86-64.zip"   >> "$LOGFILE" 2>&1
